FROM image-registry.openshift-image-registry.svc:5000/bootc/fedora-bootc:44

RUN <<EOF
set -euo pipefail

# base rpms
dnf install -y tcpdump pciutils man vim-enhanced btop tuned tmux git libatomic glibc-langpack-en \
